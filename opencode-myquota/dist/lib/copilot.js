...
function buildLegacyHeaders(token) {
    return {
        "Content-Type": "application/json",
        Accept: "application/json",
...
function formatQuotaLine(name, quota, width = 20) {
    if (!quota)
        return "";
    if (quota.unlimited) {
...
function getResetCountdown(resetDate) {
...
function formatCopilotUsage(data) {
    const lines = [];
...
function formatPublicBillingUsage(data, tier) {
    const lines = [];
...
export async function queryCopilotUsage(authData) {
