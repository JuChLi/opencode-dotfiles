...
export const MyQuotaPlugin = async () => {
    return {
        tool: {
            myquota: tool({
                description: "Query all AI account quota (GitHub Copilot, OpenAI, Z.ai, MiniMax). Returns remaining quota percentages, usage stats, and reset countdowns with visual progress bars.",
                args: {},
                async execute() {
...
function collectResult(result, title, results, errors) {
    if (!result)
        return;
...
//# sourceMappingURL=myquota.js.map