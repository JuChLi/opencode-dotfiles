...
/**
 * Load OpenCode auth.json
 * Note: mystatus hard-codes ~/.local/share/opencode/auth.json, we follow it for parity.
 * If you need a Windows-specific location, add extra candidates here.
 */
